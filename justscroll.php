...
<style type="text/css">
    ...
    #hello img{text-align: center;position: fixed;box-shadow: 1px 0px 10px #888;}
    #hide li {border-left: 1px solid gray;list-style: none;padding-left: 10px;padding-right: 10px;}
